...
export interface ActionsPageConfig_menu_edges_node_menu {
  ...
  readonly subtree: ReadonlyArray<
    ActionsPageConfig_menu_edges_node_menu_subtree | null
  > | null;
}
...
export interface ActionsPageConfig_menu_edges_node {
  ...
  readonly menu: ReadonlyArray<
    ActionsPageConfig_menu_edges_node_menu | null
  > | null;
}
...
export interface ActionsPageConfig_siteConfig_edges_node {
  ...
  readonly owners: ReadonlyArray<
    ActionsPageConfig_siteConfig_edges_node_owners | null
  > | null;
  readonly languages: ReadonlyArray<
    ActionsPageConfig_siteConfig_edges_node_languages | null
  > | null;
  readonly slimHeaderLinks: ReadonlyArray<
    ActionsPageConfig_siteConfig_edges_node_slimHeaderLinks | null
  > | null;
  readonly socialLinks: ReadonlyArray<
    ActionsPageConfig_siteConfig_edges_node_socialLinks | null
  > | null;
  readonly footerLinks: ReadonlyArray<
    ActionsPageConfig_siteConfig_edges_node_footerLinks | null
  > | null;
}
...
export interface ActionsPageConfig_forms_edges_node {
...
export interface ActionsPageConfig_forms_edges {
  readonly __typename: "FormYamlEdge";
  readonly node: ActionsPageConfig_forms_edges_node;
}

export interface ActionsPageConfig_forms {
  readonly __typename: "FormYamlConnection";
  readonly edges: ReadonlyArray<ActionsPageConfig_forms_edges>;
}
...
export interface ActionsPageConfig {
  ...
  readonly forms: ActionsPageConfig_forms | null;
}
