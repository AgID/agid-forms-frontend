...
export interface NotFoundConfig_allConfigYaml_edges_node_menu_subtree {
...
export interface NotFoundConfig_allConfigYaml_edges_node_menu {
  ...
  readonly name: string | null;
  readonly slug: string | null;
  readonly subtree: ReadonlyArray<(NotFoundConfig_allConfigYaml_edges_node_menu_subtree | null)> | null;
}
