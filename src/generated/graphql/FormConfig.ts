...
export interface FormConfig_allFormYaml_edges_node_sections_fields_options {
  readonly __typename: "FormYamlSectionsFieldsOptions";
  readonly value: string | null;
  readonly label: string | null;
}

export interface FormConfig_allFormYaml_edges_node_sections_fields {
  readonly __typename: "FormYamlSectionsFields";
  ...
  readonly options: ReadonlyArray<(FormConfig_allFormYaml_edges_node_sections_fields_options | null)> | null;
}
...
export interface FormConfig_allFormYaml_edges_node_sections {
  ...
  readonly title: string | null;
  readonly description: string | null;
  readonly fields: ReadonlyArray<(FormConfig_allFormYaml_edges_node_sections_fields | null)> | null;
}
