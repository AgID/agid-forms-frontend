...
export interface PageConfig_menu_edges_node_menu {
  ...
  readonly name: string | null;
  readonly slug: string | null;
  readonly subtree: ReadonlyArray<PageConfig_menu_edges_node_menu_subtree | null> | null;
}
...
export interface PageConfig_siteConfig_edges_node {
  ...
  readonly owners: ReadonlyArray<PageConfig_siteConfig_edges_node_owners | null> | null;
  readonly languages: ReadonlyArray<PageConfig_siteConfig_edges_node_languages | null> | null;
  readonly slimHeaderLinks: ReadonlyArray<PageConfig_siteConfig_edges_node_slimHeaderLinks | null> | null;
  readonly socialLinks: ReadonlyArray<PageConfig_siteConfig_edges_node_socialLinks | null> | null;
  readonly footerLinks: ReadonlyArray<PageConfig_siteConfig_edges_node_footerLinks | null> | null;
}
