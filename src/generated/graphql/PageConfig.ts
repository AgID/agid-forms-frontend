...
export interface PageConfig_allConfigYaml_edges_node_menu_subtree {
...
export interface PageConfig_allConfigYaml_edges_node_menu {
  ...
  readonly name: string | null;
  readonly slug: string | null;
  readonly subtree: ReadonlyArray<(PageConfig_allConfigYaml_edges_node_menu_subtree | null)> | null;
}

export interface PageConfig_allConfigYaml_edges_node {
  readonly __typename: "ConfigYaml";
  readonly menu: ReadonlyArray<(PageConfig_allConfigYaml_edges_node_menu | null)> | null;
}
